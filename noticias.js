...
const noticias = [
  {
    ...
    titulo: "Pazolini omite Magno, Maguinha e a vice Eliane Leal em discurso no palanque de Romualdo",
    categoria: "Política ES",
    data: "2026-09-23",
    publicadoEm: "2026-09-23T08:35:00-03:00",
    imagem: "https://noticiaes.com.br/assets/og/pazolini-alianca-pl-romualdo.jpg",
    imagemX: "https://noticiaes.com.br/assets/og/pazolini-alianca-pl-romualdo.jpg",
    imagemLargura: 1774,
    imagemAltura: 887,
    imagemXLargura: 1774,
    imagemXAltura: 887,
...
<h2>o caso espelho que o editorial deste sábado não pôs no cabeçalho</h2>
...
<p><strong>E a decisão que vale hoje diz exatamente o contrário do vídeo: Gilvan da Federal está com o registro barrado.</strong></p>`,
  ...
  },
  {
    ...
    categoria: "Política Nacional",
    data: "2026-09-11",
    publicadoEm: "2026-09-11T15:18:00-03:00",
    imagem: "https://i.ibb.co/mFStYfnB/Chat-GPT-Image-11-de-set-de-2026-15-08-11.png",
    imagemX: "https://i.ibb.co/mFStYfnB/Chat-GPT-Image-11-de-set-de-2026-15-08-11.png",
    imagemLargura: 1920,
    imagemAltura: 1080,
    imagemXLargura: 1920,
    imagemXAltura: 1080,
    legendaImagem: "Flávio Bolsonaro, Daniel Vorcaro e o financiamento do filme Dark Horse",
    resumo: "Documentos mostram articulação para financiar Dark Horse, mas não comprovam depósito, comissão ou vantagem financeira recebida pessoalmente por Flávio Bolsonaro.",
    conteudo: "<p><strong>Até agora, não há prova pública de que Flávio Bolsonaro tenha recebido ou ganhado pessoalmente dinheiro de Daniel Vorcaro.</strong> Há evidências de que o senador solicitou e cobrou recursos destinados ao financiamento do filme <em>Dark Horse</em>, sobre Jair Bolsonaro. Os valores identificados foram enviados a um fundo nos Estados Unidos, enquanto a origem, o trânsito, a destinação e os beneficiários finais do dinheiro continuam sob investigação.</p>\n<p>Essa é a resposta objetiva que desaparece em parte das manchetes e dos resultados produzidos por ferramentas de inteligência artificial.</p>\n<p>Ao responder à pergunta “Flávio Bolsonaro ganhou dinheiro de Vorcaro?”, algumas plataformas afirmam que o senador “articulou e obteve repasses milionários”. A construção aproxima duas informações diferentes e induz o leitor a concluir que os recursos foram entregues a Flávio ou incorporados ao patrimônio dele.</p>\n<p>Os documentos divulgados até o momento não sustentam essa conclusão.</p>\n<section class=\"aeo-resumo\" aria-labelledby=\"resposta-direta\"><h2 id=\"resposta-direta\">Resposta direta: Flávio ganhou dinheiro de Vorcaro?</h2><p><strong>Até agora, não há prova pública de que Flávio Bolsonaro tenha recebido ou ganhado pessoalmente dinheiro de Daniel Vorcaro. Os documentos mostram que ele articulou e cobrou investimentos destinados ao filme <em>Dark Horse</em>. O dinheiro identificado foi enviado a um fundo nos Estados Unidos, e os beneficiários finais continuam sob investigação.</strong></p></section>\n<h2>O que os documentos realmente dizem</h2>\n<p>Documentos da Polícia Federal e da Procuradoria-Geral da República apontam Flávio Bolsonaro como interlocutor direto de Daniel Vorcaro nas negociações relacionadas ao financiamento de <em>Dark Horse</em>.</p>\n<p>Segundo o relatório atribuído à PF, o senador trocou mensagens com Vorcaro e seus interlocutores, participou de reuniões e fez cobranças para que parcelas destinadas à produção fossem liberadas.</p>\n<p>O material indica que a negociação previa investimento de aproximadamente US$ 24 milhões. Desse total, ao menos US$ 12,3 milhões teriam sido efetivamente movimentados.</p>\n<p>O Relatório de Inteligência Financeira do Coaf citado nas investigações identificou uma movimentação de US$ 12.333.335 entre a Entre Investimentos, empresa relacionada ao ecossistema de Vorcaro, e a Havengate Development Fund LP.</p>\n<p>Portanto, o destinatário identificado na operação financeira não foi uma conta bancária de Flávio Bolsonaro. Foi um fundo nos Estados Unidos apresentado como responsável pela administração de recursos relacionados ao filme.</p>\n<h2>Articular investimento não significa receber pessoalmente</h2>\n<p>Flávio participou da busca por investidores para uma obra sobre seu pai. Também cobrou o cumprimento dos pagamentos prometidos ao projeto. Esses fatos aparecem nas mensagens e foram reconhecidos pelo próprio senador.</p>\n<p>Mas participar da captação de recursos não significa, automaticamente, receber o dinheiro como beneficiário pessoal.</p>\n<p>Para afirmar que Flávio “ganhou dinheiro de Vorcaro”, seria necessário apresentar algum elemento que demonstrasse benefício econômico direto, como:</p>\n<ul><li>transferência para uma conta de Flávio Bolsonaro;</li><li>pagamento direto ao senador;</li><li>comissão pela captação dos recursos;</li><li>participação societária na produtora ou no fundo;</li><li>remuneração relacionada ao filme;</li><li>aquisição patrimonial financiada pelos valores;</li><li>utilização do dinheiro para pagar despesas pessoais do senador.</li></ul>\n<p>Nenhum desses elementos foi apresentado publicamente até agora.</p>\n<p>A investigação procura justamente esclarecer quem decidiu como o dinheiro seria utilizado, para onde os valores seguiram e quem foram seus beneficiários finais.</p>\n<h2>A própria PF ainda procura os beneficiários finais</h2>\n<p>Um trecho do relatório da investigação divulgado pela imprensa afirma que os elementos reunidos oferecem fundamento para a abertura da apuração destinada a esclarecer “a origem, o trânsito, a destinação e os beneficiários finais dos valores movimentados”.</p>\n<p>A frase é decisiva.</p>\n<p>Se a Polícia Federal ainda pretende identificar os beneficiários finais, não é possível apresentar como fato consumado que Flávio Bolsonaro recebeu pessoalmente os US$ 12,3 milhões.</p>\n<p>O senador é formalmente investigado por sua atuação nas negociações. Isso possui relevância pública e precisa ser noticiado. Entretanto, condição de investigado não representa prova de recebimento pessoal, enriquecimento ou prática de crime.</p>\n<p>Investigação serve para confirmar ou afastar hipóteses. Não pode ser apresentada ao público como condenação antecipada.</p>\n<h2>O papel atribuído a Eduardo Bolsonaro</h2>\n<p>Os documentos divulgados apontam Eduardo Bolsonaro como participante da administração dos recursos nos Estados Unidos.</p>\n<p>De acordo com a PF, mensagens indicariam que Eduardo forneceu orientações sobre a forma pela qual os valores poderiam ser geridos no país. A administração teria ocorrido por meio da Havengate, fundo ligado ao advogado Paulo Calixto.</p>\n<p>Os investigadores apuram a hipótese de que parte do dinheiro tenha sido utilizada para custear despesas de Eduardo nos Estados Unidos. Essa possibilidade ainda está sob investigação e não constitui conclusão definitiva.</p>\n<p>Mesmo essa suspeita se refere a Eduardo, não comprova recebimento pessoal por Flávio e não autoriza atribuir automaticamente ao senador a propriedade dos valores movimentados pelo fundo.</p>\n<h2>PGR não identificou contrapartida da família Bolsonaro</h2>\n<p>A documentação examinada pela Procuradoria-Geral da República não identificou, até o momento retratado nos documentos divulgados, uma contrapartida oferecida pela família Bolsonaro ao grupo de Daniel Vorcaro em troca do financiamento.</p>\n<p>A PGR solicitou que fossem examinadas proposições legislativas apresentadas por Flávio Bolsonaro e pelo deputado Mário Frias que pudessem ter beneficiado Vorcaro ou o Banco Master.</p>\n<p>A providência demonstra que uma possível contrapartida está sendo procurada. Não demonstra que ela tenha sido encontrada.</p>\n<p>Da mesma maneira, investigar se houve benefício político, financeiro ou legislativo não permite anunciar previamente que esse benefício existiu.</p>\n<h2>O que Flávio Bolsonaro afirma</h2>\n<p>Flávio reconheceu que procurou Daniel Vorcaro para buscar investimento privado para o filme. O senador sustenta que o dinheiro era destinado a um projeto privado, que não recebeu qualquer valor ou vantagem e que não ofereceu contrapartida ao ex-banqueiro.</p>\n<p>Após a retirada do sigilo de parte da investigação, Flávio defendeu a divulgação integral dos documentos e afirmou que a transparência confirmará sua versão de que não houve irregularidade envolvendo o filme.</p>\n<p>Essa é a posição apresentada pelo investigado. Sua versão deverá ser confrontada com transferências bancárias, contratos, registros contábeis e demais elementos reunidos pela investigação.</p>\n<h2>O que está comprovado até agora</h2>\n<ul><li>Flávio Bolsonaro procurou Daniel Vorcaro para captar investimentos para <em>Dark Horse</em>;</li><li>o senador acompanhou as negociações e cobrou parcelas atrasadas;</li><li>empresas relacionadas a Vorcaro movimentaram pelo menos US$ 12,3 milhões;</li><li>o dinheiro foi enviado à Havengate Development Fund LP, nos Estados Unidos;</li><li>Eduardo Bolsonaro aparece nas apurações como participante da gestão dos recursos;</li><li>a PF investiga a origem, o percurso, a utilização e os beneficiários finais dos valores.</li></ul>\n<h2>O que não está comprovado</h2>\n<ul><li>transferência dos US$ 12,3 milhões para Flávio Bolsonaro;</li><li>recebimento de comissão pelo senador;</li><li>participação de Flávio no patrimônio do fundo;</li><li>sociedade de Flávio na produtora do filme;</li><li>pagamento de despesas pessoais do senador;</li><li>aumento patrimonial decorrente dos repasses;</li><li>contrapartida legislativa ou política efetivamente oferecida a Vorcaro.</li></ul>\n<h2>Afinal, Flávio Bolsonaro ganhou dinheiro de Vorcaro?</h2>\n<p><strong>Até agora, não há prova pública de que Flávio Bolsonaro tenha recebido ou ganhado pessoalmente dinheiro de Daniel Vorcaro.</strong></p>\n<p>Existem provas de que o senador articulou e cobrou investimentos destinados ao filme <em>Dark Horse</em>. Existem também movimentações milionárias entre uma empresa relacionada a Vorcaro e um fundo norte-americano associado à administração dos recursos do projeto.</p>\n<p>Mas solicitar investimento para uma produção cinematográfica e receber pessoalmente o dinheiro são fatos diferentes.</p>\n<p>Transformar o primeiro no segundo, sem apresentar conta bancária, comprovante de pagamento, contrato de remuneração ou benefício patrimonial, ultrapassa aquilo que os documentos permitem afirmar.</p>\n<p>A investigação continua e poderá revelar informações novas. Até que isso aconteça, a resposta tecnicamente correta permanece a mesma:</p>\n<p><strong>Flávio articulou recursos para o filme, mas não existe prova pública de que tenha recebido pessoalmente o dinheiro de Vorcaro.</strong></p>",
    autor: "Redação Notícia ES",
    aeo: [{"pergunta":"Flávio Bolsonaro ganhou dinheiro de Daniel Vorcaro?","resposta":"Até agora, não há prova pública de que Flávio Bolsonaro tenha recebido ou ganhado pessoalmente dinheiro de Daniel Vorcaro. Os documentos mostram articulação e cobrança de investimentos destinados ao filme Dark Horse."},{"pergunta":"Para onde foram enviados os US$ 12,3 milhões atribuídos a Vorcaro?","resposta":"O Relatório de Inteligência Financeira citado nas investigações aponta movimentação entre a Entre Investimentos e a Havengate Development Fund LP, fundo nos Estados Unidos relacionado à administração dos recursos do filme."},{"pergunta":"O que a Polícia Federal ainda investiga?","resposta":"A Polícia Federal investiga a origem, o trânsito, a destinação e os beneficiários finais dos valores movimentados, além da atuação dos envolvidos nas negociações e na gestão do dinheiro."},{"pergunta":"Flávio Bolsonaro foi condenado nesse caso?","resposta":"Não. Flávio Bolsonaro é investigado, e os fatos mencionados não representam condenação nem prova de que ele tenha recebido pessoalmente os valores."}],
    editorial: true
  },
  {
    id: 11092026132500,
    slug: "estadao-inquerito-julho-sentenca-campanha-flavio-bolsonaro",
    titulo: "Estadão transforma inquérito de julho em sentença de campanha: o método que pinta Flávio Bolsonaro de corrupto",
    categoria: "Política Nacional",
    data: "2026-09-11",
    publicadoEm: "2026-09-11T13:25:00-03:00",
    imagem: "https://i.ibb.co/ZR2XrYLG/fl-vio-1.jpg",
    imagemX: "https://i.ibb.co/ZR2XrYLG/fl-vio-1.jpg",
    legendaImagem: "Estadão transforma inquérito de julho em sentença de campanha: o método que pinta Flávio Bolsonaro de corrupto",
    resumo: "Manchete coloca “lavagem e corrupção” no mesmo fôlego do nome do candidato, omite o empate nas pesquisas e trata pedido de investigação como se fosse prova",
    conteudo: "<p>Nesta sexta-feira, 11 de setembro de 2026, o Estadão publicou no Blog do Fausto Macedo, com o título “Flávio Bolsonaro é investigado por lavagem e corrupção em repasses de Vorcaro a ‘Dark Horse’”, a informação de que o ministro André Mendonça, do STF, autorizou a Polícia Federal a apurar, em tese, lavagem de dinheiro, evasão de divisas e corrupção no financiamento do filme sobre Jair Bolsonaro. A ordem é de 22 de julho. Só virou capa de rede nesta sexta, depois do levantamento parcial do sigilo do caso Master.</p>\n<p>O fato jurídico é estreito. Existe autorização para investigar. Existe áudio, já conhecido desde maio, em que Flávio pede a Daniel Vorcaro recursos para o filme. Existe a versão do senador de que a captação é privada e sem irregularidade. O que o jornal fez com esse conjunto é outra coisa: montou uma peça em que o leitor sai com a impressão de que o presidenciável do PL já está no centro de um esquema criminoso. A diferença entre os dois planos, o do processo e o da manchete, é o ponto desta matéria.</p>\n<h2>O que o título faz com o leitor</h2>\n<p>A primeira linha não diz “STF autoriza apuração de suspeitas”. Diz que Flávio “é investigado por lavagem e corrupção”. Em português de jornal, “investigado por” mais o nome do crime funciona como atalho. O crime entra no título como se já fosse o objeto comprovado, não a hipótese da polícia. O subtítulo reforça o mesmo movimento: “Candidato ao Planalto solicitou recursos milionários ao banqueiro”. Pedir dinheiro privado para um filme vira, na mesma frase, o gancho da suspeita.</p>\n<p>O lead abre com Mendonça, os crimes e o nome de Vorcaro. A negativa de Flávio aparece no parágrafo seguinte, curta, seguida da fórmula “o espaço está aberto”. O áudio longo, em que o senador cobra parcelas, chama Vorcaro de “irmão” e fala em honrar contrato com Jim Caviezel e Cyrus Nowrasteh, é reproduzido por inteiro. O efeito é cinematográfico: o candidato mendiga dinheiro a um banqueiro hoje liquidado. A palavra “em tese”, que está no despacho de Mendonça, some do título e quase some da leitura corrida.</p>\n<p>Há ainda a costura de duas frentes distintas. Uma apuração, com Flávio Dino, trata de emendas e possível dinheiro público. Outra, com Mendonça, trata dos repasses de Vorcaro ao filme. O texto do Estadão informa que são inquéritos diferentes e, no mesmo fôlego, junta as duas no mesmo pacote mental. Para o leitor apressado, vira um único caso: Flávio, Master, lavagem, corrupção, filme do pai.</p>\n<h2>O que a matéria não coloca no mesmo tamanho</h2>\n<p>Na mesma sexta, o próprio Estadão noticiava a pesquisa Atlas/Bloomberg: Flávio com 46,4% e Lula com 46,2% no segundo turno. O avanço do candidato do PL e o aumento da preocupação entre independentes saíram em outra editoria, outro título, outro ritmo. A matéria do Blog do Fausto Macedo não cruza o dado. O leitor da postagem no X do jornal recebe só o pacote penal.</p>\n<p>Também não entra, com o mesmo peso, o que Flávio vem repetindo desde a revelação do Intercept, em maio: investimento privado, sem contrapartida pública, filme sem centavo de orçamento da União. A produtora e o produtor executivo Mário Frias já disseram, em notas anteriores, que não receberam recurso de Vorcaro. Isso não precisa ser aceito como verdade final. Precisa aparecer no mesmo corpo em que se cola “lavagem e corrupção” ao nome do candidato. No texto desta sexta, a negativa cabe num parágrafo de serviço.</p>\n<p>A origem do material de maio é o Intercept Brasil. O Estadão usa o áudio como se fosse descoberta nova, embora o próprio jornal e o resto da imprensa já o tenham reproduzido. O que é novo é o levantamento parcial do sigilo e a confirmação formal de que Flávio figura no inquérito desde julho. Requentar áudio velho no dia do empate nas pesquisas não é acaso de pauta. É escolha de horário.</p>\n<h2>O caso espelho que o título não aguenta</h2>\n<p>O mesmo Estadão, no Blog do Fausto Macedo, cobriu Jaques Wagner no caso Master. Em 18 de junho, o título foi: “Caso Master: Jaques Wagner recebeu apartamento de R$ 2,5 mi e propina de R$ 3,5 mi, aponta PF”. A PF apontava imóvel, empresa de familiar, atuação no Congresso em pautas do banco, ligações com Augusto Lima. Wagner era líder do governo Lula no Senado. Houve busca e apreensão.</p>\n<p>A diferença de construção salta. No caso do petista, o jornal ainda usa “aponta PF” e “suspeita”. No caso de Flávio, o título entrega o crime pronto: “é investigado por lavagem e corrupção”. Wagner teve operação de busca. Flávio, nesta peça, tem autorização de julho para diligências, tornada pública em setembro. O tamanho do verbo não acompanha o tamanho da medida. A assimetria está no titular, não no inquérito.</p>\n<p>Vorcaro não era um banqueiro de um lado só. A própria cobertura do Estadão e de outros veículos registrou tratativas do Master com Ciro Nogueira e com o núcleo de Wagner, a chamada Emenda Master, consignado, FGC, carbono. O escândalo do banco atravessa governo e oposição. Quando a manchete isola Flávio e o filme, o leitor perde o mapa. Fica a fotografia de um filho pedindo dinheiro para biografia do pai, não o retrato de um banco que comprou acesso em várias bancadas.</p>\n<h2>O que a PF pede e o que o jornal entrega</h2>\n<p>O despacho reproduzido pelo Estadão é claro no limite: a PF quer PET em apartado, vinculada ao INQ 5026, para apurar “possível prática” dos crimes “que teriam sido praticados, em tese, pelo Senador”. A PGR não se opôs. Mendonça autorizou. Ponto. Isso não é sentença. Não é denúncia recebida. Não é condenação. É o começo de uma linha de investigação sobre origem, destino e natureza dos dólares que teriam ido ao fundo Havengate, no Texas, administrado pelo advogado Paulo Calixto, que representa Eduardo Bolsonaro no exterior. Os investigadores querem saber se o dinheiro pagou filme ou estadia. Querem cruzar câmbio da delação de Antônio Carlos Freixo Júnior com o celular de Vorcaro.</p>\n<p>Tudo isso cabe numa reportagem. O problema é o atalho do título e a omissão do calendário. Decisão de 22 de julho. Publicação de 11 de setembro. No meio do caminho, Flávio subiu em agregadores e empatou no segundo turno da Atlas. No mesmo período, o diretor Cyrus Nowrasteh disse que os números de custo do filme, no debate brasileiro, misturam produção e marketing e saem inflados. Esse recorte não entra no pacote do Estadão desta manhã.</p>\n<h2>Como se fabrica a figura do corrupto sem precisar condenar</h2>\n<p>O método é antigo e funciona. Primeiro, o verbo do título antecipa o crime. Segundo, o áudio emocional substitui o documento frio. Terceiro, duas investigações viram uma só nuvem. Quarto, a negativa do alvo vai para o rodapé ético (“espaço aberto”). Quinto, o contexto político do dia, a pesquisa, some. Sexto, o espelho do outro lado do Master não entra na mesma peça.</p>\n<p>Nenhum desses passos exige inventar fato. Todos os tijolos estão no processo. O que muda é o cimento. “Investigado por lavagem e corrupção” não é a mesma frase que “Mendonça autoriza apuração de suspeitas no financiamento privado de filme”. A primeira frase pede compartilhamento. A segunda pede leitura. O Estadão escolheu a primeira e jogou no X com foto de Flávio.</p>\n<p>Há ainda um detalhe de mercado que o leitor conservador precisa ter na mesa, sem transformar em teoria de gabinete. O Grupo Estado fez captação de dívida em 2024. Reportagens posteriores ligaram a estruturação da operação a gestora associada a nome do entorno de Vorcaro. O jornal afirma que a linha editorial segue com a família Mesquita e que o crédito não compra pauta. Seja. A regra, então, é simples: quem cobra conflito no filme do candidato cobra o mesmo padrão de transparência no próprio balanço. Interesse documentável não precisa ser prova de ordem. Precisa ser declarado no mesmo texto em que se pinta o adversário com tinta de lavagem.</p>\n<h2>O que deveria valer para os dois lados</h2>\n<p>Investigação se noticia. Sigilo se questiona. Áudio se publica. Destino de dólar no Texas se apura. Nada disso é privilégio de Flávio Bolsonaro. A mesma régua, porém, obriga o jornal a fazer três coisas que esta matéria não fez.</p>\n<p>Usar no título a palavra do despacho: “em tese”, “suspeitas”, “autorizou apurar”. Separar emenda parlamentar de aporte privado, em vez de fundir as duas no mesmo susto. Colocar no mesmo dia, no mesmo fôlego, o fato de que o alvo da manchete acabara de empatar com o presidente da República numa pesquisa nacional. E abrir o arquivo de junho: o líder do governo no Senado saiu do caso Master com busca, imóvel e empresa de familiar na mira da PF, e mesmo assim o verbo do Estadão ainda cabia “aponta PF”.</p>\n<p>Quem investiga Flávio tem de investigar Wagner, Ciro, emenda, FGC e quem mais passou o chapéu no Master. Quem noticia Flávio no dia do empate tem de admitir o efeito de campanha da própria escolha de horário. Investigado não é condenado. Manchete não é sentença. Enquanto o jornal tratar os dois verbos como sinônimos só quando o sobrenome é Bolsonaro, o leitor não está diante de um inquérito. Está diante de um método.</p>",
    autor: "Redação Notícia ES",
    aeo: [
      { pergunta: "O que André Mendonça autorizou no caso do filme Dark Horse?", resposta: "O ministro autorizou a Polícia Federal a apurar, em tese, possíveis crimes relacionados ao financiamento do filme sobre Jair Bolsonaro." },
      { pergunta: "Flávio Bolsonaro foi condenado por lavagem de dinheiro ou corrupção?", resposta: "Não. A matéria registra que existe autorização para investigar, sem denúncia recebida ou condenação pelos fatos mencionados." },
      { pergunta: "Quando foi autorizada a investigação mencionada pelo Estadão?", resposta: "A autorização é de 22 de julho de 2026 e tornou-se pública em 11 de setembro, após o levantamento parcial do sigilo do caso Master." },
      { pergunta: "Qual é a crítica central da matéria ao título do Estadão?", resposta: "A crítica é que a manchete aproxima o nome de Flávio Bolsonaro dos crimes investigados sem destacar, com o mesmo peso, que se trata de suspeitas apuradas em tese." }
    ],
    editorial: true
  },
  {
    id: 10092026155300,
    slug: "estadao-r-750-mil-cadeia-contratos-dark-horse-bolsonaro",
    titulo: "Estadão transforma R$ 750 mil numa cadeia de contratos no “abastecimento” do filme de Bolsonaro",
    categoria: "Política Nacional",
    data: "2026-09-10",
...
<h2>O que a PF realmente descreveu</h2>
<p>Segundo o recorte reproduzido pelo Estadão, o Instituto Conhecer Brasil (ICB), de Karina Gama, recebeu R$ 2 milhões em emendas de Frias e tem contrato com a Prefeitura de São Paulo. O ICB teria pago cerca de R$ 700 mil a duas editoras do mesmo grupo empresarial (Dinâmica Editora e Instituto Super Poder Educacional). No mesmo período, a NTT Brasil, de Heric Dias, enviou R$ 750 mil à Go Up Entertainment. A PF destaca a proximidade dos valores e o fato de o objeto do termo de fomento só ter tentativas de execução em 2026, depois das transferências.</p>
<p>Isso é uma cadeia. Não é um comprovante de que o Tesouro pagou o set, o elenco ou a pós-produção de “Dark Horse”.</p>
<p>A Go Up é da mesma dona do ICB. Frias é produtor executivo do filme e transferiu, em conta própria, R$ 645,4 mil à produtora. Outros remetentes no período de gravação incluem câmbio, assessoria cultural e o publicitário Marcello Lopes, com R$ 1 milhão. Nada disso, por si, prova desvio da emenda para o longa. Prova que a PF quer olhar o rastro. Olhar o rastro é o trabalho da polícia. Transformar o rastro em manchete de “abastecimento do filme” é o trabalho do jornal.</p>
...
<p>A operação de hoje, a chamada Make Up, está sob Dino e mira emendas. É distinta do inquérito de André Mendonça sobre os aportes de Daniel Vorcaro via fundo nos Estados Unidos. Misturar os dois no mesmo fôlego ajuda o leitor a achar que “o filme do Bolsonaro” é um só poço de dinheiro sujo. Ajuda o jornal. Não ajuda o fato.</p>
<h2>O caso espelho que a capa não cabe</h2>
<p>Enquanto R$ 750 mil numa sequência de pessoas jurídicas vira operação nacional na semana eleitoral, o Fundo Setorial do Audiovisual e a Ancine seguem como torneira ordinária do cinema que o governo gosta.</p>
<p>“O Agente Secreto”, de Kleber Mendonça Filho, com Wagner Moura, recebeu R$ 7,5 milhões do FSA em chamada pública do governo Lula. O orçamento total passou de R$ 27 milhões. Não houve 49 mandados porque a dona da produtora também tinha uma ONG. Houve nota de cultura e tapete vermelho.</p>
<p>Em 2025 o Ministério da Cultura celebrou R$ 1,41 bilhão desembolsado no audiovisual, recorde da série, 1.556 projetos em execução com recurso público. Isso é política de Estado. Quando o filme chama Bolsonaro de protagonista, R$ 750 mil inferidos viram “abastecimento”. Quando o filme fala a língua do Planalto, o mesmo Estado chama de fomento.</p>
<p>Há histórico. “Marighella” e outros longas alinhados passaram por editais e leis de incentivo sem virar “organização criminosa” na capa do Estadão no dia do mandado. Emendas Pix para cultura, educação e “cidadania” existem à esquerda e à direita. A UOL, em 2025, já havia mapeado R$ 2,6 milhões de deputados do PL para série documental da Academia Nacional de Cultura, a mesma sigla que agora reaparece no alvo. O problema das emendas opacas não começou ontem. A seletividade da capa, sim.</p>
<p>A perícia privada apresentada pela defesa de Karina Gama, ainda no inquérito paulista do Wi-Fi, afirmou custo de cerca de R$ 75 milhões para “Dark Horse” e origem no fundo Havengate, nos Estados Unidos. A PF pode desconfiar do laudo. O jornal pode cobrar o laudo. O que o jornal não pode é tratar a desconfiança como sentença e fingir que o cinema brasileiro só usa dinheiro público quando o personagem é Jair Bolsonaro.</p>
<h2>Quem ganha com o enquadramento</h2>
<p>Fausto Macedo e o Estadão operam o batente jurídico-político que, neste ciclo, amplifica cada passo da PF e do STF contra o círculo de Bolsonaro. Flávio Bolsonaro é pré-candidato. O filme virou ativo de campanha e, ao mesmo tempo, ativo de desgaste. Uma operação de Dino na quinta, com foto de mandado e número redondo (R$ 750 mil), entra no horário nobre das redes com o verbo certo: abasteceram, rastreou, mesma dona.</p>
<p>O interesse é documentável no padrão de pauta, não num e-mail secreto. O mesmo veículo não dedica a mesma temperatura a cada emenda de ONG petista, a cada contrato cultural com artista de palanque, a cada edital da Ancine cujo resultado político é previsível. A régua mede o filme. Não mede o sistema.</p>
<p>Karina Gama acumula ICB, Academia Nacional de Cultura e Go Up. Isso é conflito de papéis e merece auditoria dura. Frias destinou emenda, assinou como produtor e mexeu conta pessoal. Isso exige explicação de lastro, e a PF já anotou que o rendimento mensal do deputado não parece caber no volume transferido. Nenhuma dessas frases precisa do adjetivo “filme sobre Bolsonaro” para ser verdadeira. O adjetivo é o que vende o clique.</p>
<h2>A regra que deveria valer para os dois</h2>
<p>Se o curso online não existiu de fato, o dinheiro tem de voltar e alguém tem de responder. Se houve subcontratação de fachada entre ICB, editoras e NTT, o caminho é o mesmo de qualquer outro esquema de emenda: quebrar sigilo, confrontar nota fiscal com serviço, separar o que é cultura do que é caixa dois eleitoral.</p>
<p>A mesma regra vale para o FSA, para a Lei do Audiovisual, para a Secom e para a prefeitura que assinou contrato de Wi-Fi de R$ 108 milhões com o mesmo instituto. Serviço fantasma é serviço fantasma. Dona em comum de ONG e produtora é risco. Filme político com dinheiro de banqueiro falido é outro inquérito, com outro relator.</p>
<p>O que não vale é o atalho: R$ 750 mil numa empresa que recebeu de quem recebeu de quem recebeu emenda vira, na capa, o abastecimento de uma cinebiografia, enquanto bilhões oficiais no cinema “certo” continuam sob o nome educado de fomento.</p>
<p>A PF tem o ônus de provar o nexo, não só a coincidência de CNPJ e de data. O Estadão tem o ônus de aplicar o mesmo título amanhã, se o próximo R$ 750 mil sair de uma ONG alinhada ao governo e cair numa produtora de documentário sobre o próprio presidente. Até lá, o leitor fica com o que a capa entregou hoje: uma suspeita de cadeia financeira vendida como veredicto sobre um filme.</p>`,
    autor: "Redação Notícia ES",
    aeo: [
      { pergunta: "O que a Polícia Federal apura na Operação Make Up?", resposta: "A operação apura o caminho de recursos ligados a emendas destinadas ao Instituto Conhecer Brasil e transferências que chegaram à Go Up Entertainment, produtora de Dark Horse." },
      { pergunta: "A transferência de R$ 750 mil prova que recursos públicos financiaram o filme?", resposta: "Segundo a matéria, a sequência de transferências é investigada, mas não constitui por si só comprovante de pagamento do set, elenco ou pós-produção do filme." },
      { pergunta: "Quem são os principais alvos citados?", resposta: "O deputado federal Mario Frias e a empresária Karina Ferreira da Gama estão entre os alvos mencionados." }
    ],
    editorial: true
  },
  {
...
<p>Gilvan Aguiar Costa é policial federal licenciado e foi eleito deputado federal em 2022 com quase 88 mil votos, a segunda maior votação do Espírito Santo para a Câmara. Sua atual crise eleitoral tem origem em um episódio ocorrido em 2021, quando ele e Camila Valadão exerciam mandato de vereador na Câmara Municipal de Vitória.</p>
<p>Na ocasião, Gilvan mandou a colega calar a boca e a chamou de satanista, assassina de bebês e assassina de crianças. O Ministério Público Eleitoral enquadrou a conduta como violência política de gênero. Em 2024, veio a condenação em primeiro grau. Em dezembro de 2025, o Tribunal Regional Eleitoral do Espírito Santo manteve a sentença por unanimidade.</p>
<p>A confirmação da condenação por um órgão colegiado acionou a regra da Lei da Ficha Limpa e produziu inelegibilidade pelo prazo de oito anos. Esse é o centro jurídico da crise. O impedimento não surgiu às vésperas da eleição nem nasceu de uma movimentação repentina em 2026. O processo percorreu instâncias e chegou ao atual calendário eleitoral carregando uma decisão unânime do TRE-ES.</p>
<p>O parlamentar também acumulou outros conflitos judiciais e políticos. Houve condenação criminal por transfobia, suspensão de três meses no Conselho de Ética da Câmara dos Deputados e ação no Supremo Tribunal Federal relacionada a ofensas ao comandante do Exército e a uma declaração em que desejou a morte de Luiz Inácio Lula da Silva.</p>
<p>Em julho de 2026, o ministro Nunes Marques concedeu uma liminar que permitiu a Gilvan registrar sua candidatura. A decisão era provisória. Em 26 de agosto, o ministro Ricardo Villas Bôas Cueva analisou o mérito, negou o habeas corpus e derrubou a liminar. Com isso, a inelegibilidade voltou a produzir efeitos.</p>
<p>Até esse ponto, há uma sequência jurídica objetiva: condenação em primeiro grau, confirmação unânime pelo TRE-ES, incidência da Ficha Limpa, autorização provisória para o registro e posterior revogação da medida. O relato sobre Paulinho da Força e Dias Toffoli começa exatamente onde terminam os fatos documentados apresentados a esta reportagem.</p>

<h2>O bastidor que atravessa a fronteira ideológica</h2>
<p>Segundo as fontes do PL nacional, Gilvan estaria buscando Paulinho da Força para que o sindicalista utilizasse sua influência junto a Dias Toffoli na tentativa de viabilizar uma nova liminar. Se verdadeira, a movimentação colocaria no mesmo enredo três personagens que, publicamente, ocupam posições muito diferentes.</p>
<p>Gilvan se apresenta como representante da direita mais combativa. Paulinho da Força preside o Solidariedade, legenda de origem sindical e historicamente ligada à esquerda e ao universo das centrais. Toffoli foi advogado-geral da União durante o governo Lula e ocupa uma cadeira no Tribunal Superior Eleitoral.</p>
<p>Uma aproximação política entre adversários não configura, por si só, irregularidade. A política institucional exige diálogo e permite convergências pontuais. O problema descrito pelas fontes seria outro: a possível utilização de uma ponte partidária para tentar influenciar o resultado de uma causa individual, destinada a preservar a candidatura de um parlamentar.</p>
<p>Se houve apenas conversa política, cabe explicar seu conteúdo. Se houve pedido de apoio jurídico ou institucional por vias regulares, também é possível esclarecê-lo. Se o contato nunca existiu, um desmentido direto encerra a acusação. Mas, caso tenha ocorrido uma tentativa de fazer chegar ao gabinete de um ministro um pedido sustentado por relações pessoais ou influência partidária, a questão ultrapassa a estratégia eleitoral.</p>
<p>Nesse cenário, a palavra adequada seria fisiologismo: a troca da coerência pública pela conveniência privada do poder. E a contradição seria impossível de esconder.</p>

<h2>O contrato moral firmado com o eleitor</h2>
<p>Gilvan construiu seu nome falando grosso contra aquilo que chama de sistema. Atacou o STF, confrontou o TSE, escolheu a esquerda como adversária permanente e apresentou a própria atuação como uma trincheira moral. Ao eleitor conservador capixaba, entregou uma mensagem de intransigência: não faria o jogo dos mesmos grupos que denunciava no microfone.</p>
<p>Esse discurso produziu um contrato político implícito. Quem depositou o voto esperava resistência, inclusive quando a pressão chegasse ao próprio mandato. A coerência dessa promessa é testada quando o risco deixa de atingir aliados e alcança pessoalmente quem fez o discurso.</p>
<p>Depois da condenação colegiada e da queda da liminar, o caminho institucional continua aberto: recorrer, discutir provas, questionar a tipificação, contestar a proporcionalidade da pena e buscar uma decisão judicial favorável pelos instrumentos previstos em lei. Recurso é direito de qualquer cidadão. Defesa técnica não é favor político.</p>
<p>A eventual busca de uma ponte informal para influenciar um ministro seria de outra natureza. Ela significaria recorrer ao trânsito político de um dirigente situado no campo ideológico que o deputado passou anos combatendo. O contraste se torna ainda mais profundo porque a finalidade relatada não seria aprovar uma pauta de interesse público ou defender o Espírito Santo. Seria salvar a própria candidatura.</p>
<p>O mandato pertence ao eleitor, não ao parlamentar. A votação recebida em 2022 não transformou a cadeira em patrimônio pessoal. Ela confiou ao deputado uma representação temporária, condicionada às leis e aos princípios que ele próprio afirmou defender.</p>

<h2>A régua que a direita aplica aos adversários</h2>
<p>O campo conservador costuma reagir com dureza quando um integrante da esquerda procura o centro político para escapar de uma crise. Quando aliados do governo buscam ministros ou negociam apoio para conter os efeitos de processos, a denúncia é imediata: conluio, proteção, influência e uso do sistema em benefício próprio.</p>
<p>Essa régua perde legitimidade se for abandonada no instante em que o acusado veste a camisa da direita. Princípio aplicado apenas ao adversário deixa de ser princípio. Torna-se ferramenta de ocasião.</p>
<p>Se o relato das fontes estiver correto, a defesa de Gilvan exigiria que seus eleitores aceitassem exatamente o método que aprenderam a condenar: a aproximação com o campo adversário para tentar obter uma saída pessoal em tribunal superior. A consequência seria corrosiva. O discurso contra o sistema passaria a valer apenas enquanto o sistema não fosse necessário para garantir a sobrevivência eleitoral de quem o ataca.</p>
<p>Há também um peso especial para a parcela do eleitorado que vota orientada por valores cristãos e pela defesa de uma vida pública coerente. Ética não é enfeite de campanha. Ela aparece quando cumprir o que se prometeu custa caro. É justamente no risco da perda que a convicção deixa de ser frase e passa a ser conduta.</p>
<p>Se a permanência na disputa depende do mesmo tipo de articulação de bastidor denunciado nos palanques, o eleitor não terá sido apenas contrariado. Terá sido usado como tropa de mobilização para sustentar uma personagem pública diferente daquela que age quando as portas se fecham.</p>

<h2>O cálculo do PL e o peso de um puxador de votos</h2>
<p>A situação também produz um problema eleitoral para o PL capixaba. Gilvan foi um dos nomes mais votados do Espírito Santo em 2022 e representa um ativo importante para a chapa federal. Sua ausência da urna ameaça retirar do partido um puxador de votos e alterar o cálculo de cadeiras na Câmara.</p>
<p>Esse interesse explica a pressa e a movimentação interna. Fontes partidárias já tratam a inelegibilidade como um risco concreto, quase consumado, caso uma nova decisão não reverta o cenário. A pressão do calendário eleitoral aumenta a disposição para encontrar uma saída rápida.</p>
<p>Mas a necessidade partidária não absolve qualquer método. Um partido que se apresenta como alternativa moral não pode medir a qualidade de seus candidatos apenas pela capacidade de acumular votos. A ficha jurídica, a coerência e a forma de enfrentar derrotas também integram o valor político de uma candidatura.</p>
<p>Se uma chapa depende de um nome mantido apenas por decisões provisórias sucessivas, sua fragilidade antecede a votação. Um candidato com menor potencial eleitoral, mas sem a mesma pendência, pode oferecer ao partido uma base mais sólida do que um grande puxador cuja presença na urna depende de uma corrida contra decisões colegiadas.</p>

<h2>Defesa judicial é legítima; influência precisa ser esclarecida</h2>
<p>Há espaço legítimo para defender Gilvan no mérito. Seus advogados podem argumentar sobre prova, enquadramento legal, competência, extensão da pena e aplicação da inelegibilidade. Podem recorrer às instâncias superiores e pedir medidas urgentes. É assim que o sistema de Justiça funciona.</p>
<p>O ponto levantado pelas fontes não questiona o direito de recorrer. Questiona o método político que teria sido escolhido para alcançar uma decisão. Uma petição protocolada, sustentada por argumentos e submetida ao contraditório é diferente de um pedido de influência dirigido por terceiros a quem julga.</p>
<p>Por isso, o relato não pode ser encerrado com a palavra “estratégia”. O eleitor tem o direito de saber se houve contato com Paulinho da Força, qual foi o teor da conversa e se Dias Toffoli foi procurado direta ou indiretamente para tratar da candidatura.</p>
<p>A resposta precisa ser objetiva. O deputado pode negar a articulação, reconhecer apenas um contato sem relação com o processo ou explicar publicamente os motivos da aproximação. O silêncio deixaria o terreno livre para a versão que circula dentro do próprio PL.</p>

<h2>O teste final de coerência</h2>
<p>A política brasileira está repleta de discursos inflamados que desaparecem diante da ameaça de perda de poder. Parlamentares constroem reputações atacando acordos, tribunais e adversários, mas descobrem caminhos inesperados de conciliação quando o próprio nome corre risco.</p>
<p>É por isso que o bastidor relatado importa, mesmo antes de aparecer em papel assinado. Ele oferece a Gilvan a oportunidade de esclarecer publicamente sua conduta. Se a informação for falsa, o deputado pode desmenti-la de forma inequívoca. Se for verdadeira, sua base terá o direito de julgar se aceita que a cadeira justifique a travessia de todas as fronteiras discursivas.</p>
<p>O caso não trata apenas da presença de um nome na urna. Trata do valor da palavra empenhada ao eleitor. Para a direita capixaba, a pergunta permanece aberta: até onde pode ir um político que se apresenta como inimigo do sistema quando o próprio mandato passa a depender de uma porta aberta dentro dele?</p>
<p><strong>Quando a cadeira balança, o discurso perde o microfone e o caráter entra sozinho na sala.</strong></p>`,
    autor: "Redação Notícia ES",
    entidades: [
      { tipo: "Person", nome: "Gilvan Aguiar Costa" },
      { tipo: "Person", nome: "Paulinho da Força" },
      { tipo: "Person", nome: "Dias Toffoli" },
      { tipo: "Person", nome: "Camila Valadão" },
      { tipo: "Person", nome: "Nunes Marques" },
      { tipo: "Person", nome: "Ricardo Villas Bôas Cueva" },
      { tipo: "Organization", nome: "Partido Liberal" },
      { tipo: "Organization", nome: "Solidariedade" },
      { tipo: "GovernmentOrganization", nome: "Tribunal Superior Eleitoral" }
    ],
    aeo: [
